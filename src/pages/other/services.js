    ...
    <div className="row" style={{maxWidth:"1600px", margin:"0 auto", padding:"0px 25px", position:"relative"}}> 
      ...
      <div className="row">
            <div className="col-4 col-md-4">
               <h1 style={{paddingLeft: "100px", borderBottom:"3px solid pink"}}>Захирлын мэндчилгээ<span style={{color:"pink"}}>.</span></h1>
      ...
      <div className="row">
          ...
          <div class="services__item__content">
            <p class="services__item__description" style={{fontFamily:"Comfortaa, cursive;"}}>
